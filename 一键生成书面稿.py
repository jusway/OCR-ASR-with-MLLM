...
if __name__ == "__main__":
    # ---------------- 基础配置 ----------------
    audio_path = "摩诃止观-久仁法师/摩诃止观035/摩诃止观035.mp3"
    fuzzy_text_path = "摩诃止观-久仁法师/摩诃止观035/035原文模糊范围.txt"
    ...
    text_system_prompt = (
        # 角色
        "您是一位精通佛学逐字录音稿整理的资深专家。"
        # 任务
        "您的任务是将讲法长音频转录得到的【逐字稿】整理成可以通顺阅读的书面文稿。"
        
        # 信息规范
        "【逐字稿】可能会听写有误，遇到可能是谬误的字词，注意不要被带偏。"
        "不要丢失任何【逐字稿】的信息。"
        "【原文参考】是逐字稿所讲解的原文，注意参考它来校对专有名词。"
    ...
    locator_system_prompt = (
        ...
        "你是一个严谨的校对专家。"
        # 任务
        "你的任务是根据提供的【讲课稿】，在【模糊的原文范围】中截取输出作者这节课讲到的部分。"
        # 信息规范
        "对下节课的预告不需要考虑在截取范围内。"
        "对上节课的回顾不需要考虑在截取范围内。"
        # 输出规范
