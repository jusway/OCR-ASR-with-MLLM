...
原文参考是本节课的《摩诃止观辅行传弘决辑注》的节选，有四个结构：
科判（类似“△二衣食具足二，初来意”）、摩诃止观原文（比如“**得此三谛三昧，故名王三昧，一切三昧悉入其中。**”）、解释、注脚。

## 任务
请对上述【ASR语音识别稿件】进行书面语校对：修正错别字、同音字错误，去除多余啰嗦的语气词。
保留所有观点。保留所有通俗案例。保留所有类比比喻。
保留所有解释。保留师父所有的即兴讲话。乃至保留所有开玩笑的话。
虽然语音稿没有这么做，但是你要把所有摩诃止观原文作为小节标题一般插入到合适的位置。
...
校对稿的目的是：在保留所有法义、比喻、案例、即兴讲话的前提下，将口语转化为书面语。
...
# 任务文件夹（脚本自动找 .mp3）
folder_path = Path(r"摩诃止观-定智法师 2017/09正说分/2018年12月5日摩诃止观09正说分第六方便025")
