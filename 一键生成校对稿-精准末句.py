...
# 开了deepseek-pro-thinking-high还是有概率错。   deepseek-pro-nothink-stable实践后发现如果模糊原文参考没有片段，也不能变通输出【无匹配片段】
...
## 核心纪律
- 逐字逐句转化：必须保留讲演者的**所有**信息细节、举例和逻辑推演，绝对禁止任何形式的浓缩、总结、概括或删减！
- 校对就是仅修正错别字、同音字错误，去除口语化的冗余语气词（如“啊”、“那个”、“就是说”等），理顺语序。
"""
...
# 任务文件夹（脚本自动找 .mp3）
folder_path = Path(r"摩诃止观-定智法师 2017/08正说分/2018年10月29日摩诃止观08正说分第五偏圆001")
