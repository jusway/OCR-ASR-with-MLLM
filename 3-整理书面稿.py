...
if __name__ == "__main__":
    ...
    prompt_path = r"003原典提示词.txt"
    transcript_path = "摩诃止观003_逐字稿.md"
...
{transcript_text}
"""
    text_bot = GeminiText(temperature=0.3)

    output_filename = f"{Path(transcript_path).stem.replace('_逐字稿', '')}_书面稿.md"
