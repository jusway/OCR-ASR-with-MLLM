...
REFINE_SELECTED_MODEL = "pro-high"
...
## 任务
从资料中提取出**摩诃止观正文**的句子，按顺序直接拼接输出，不要使用换行符进行拼接。
直接输出结果，不说任何多余的话。
"""
# ============================================================
# ── 步骤 ③：最终校对稿 ───
# ============================================================
#
FINAL_SELECTED_MODEL = "pro-nothink"
final_system_prompt = """\
...
# 任务文件夹（脚本自动找 .mp3）
folder_path = Path(r"摩诃止观-定智法师 2017/06正说分第三显体/2018年6月6日摩诃止观06正说分第三显体002")
